...
<summary>More detail<span className="sr-only"> on haus.displays.&lt;name>.arrangement</span></summary>
...
<summary>More detail<span className="sr-only"> on haus.focus.scenes.&lt;name>.key</span></summary>
...
<summary>More detail<span className="sr-only"> on haus.focus.timers</span></summary>
