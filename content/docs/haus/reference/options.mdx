...
<summary>More detail<span className="sr-only"> on haus.trill.enable</span></summary>
...
<small>Declared in [`modules/trill/options.nix`](https://github.com/hausfold/haus/blob/main/modules/trill/options.nix).</small>
