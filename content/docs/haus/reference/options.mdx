...
<summary>More detail<span className="sr-only"> on haus.appStore.timeout</span></summary>
...
<summary>More detail<span className="sr-only"> on haus.launcher.urlScheme.confirm</span></summary>
...
<summary>More detail<span className="sr-only"> on haus.launcher.urlScheme.enable</span></summary>
