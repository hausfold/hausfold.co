...
or motion rather than system-wide size — measured, not assumed (`docs/macos-settings.md` records the sweep). So
...
`one of "latest", "claude", "codex", "opencode"` · default `"latest"` · e.g. `"claude"`
...
[`clients`](#haus-ai-clients) [`default`](#haus-ai-default) [`enable`](#haus-ai-enable) [`instructions`](#haus-ai-instructions) [`keepAwake`](#haus-ai-keepawake) [`namer`](#haus-ai-namer) [`repoRoots`](#haus-ai-reporoots) [`skill`](#haus-ai-skill)

</div>

#### `haus.ai.clients` [#haus-ai-clients]

`list of (one of "claude", "codex", "opencode")` · default `[ ]`
...
`one of "claude", "codex", "opencode"` · default `"claude"` · e.g. `"codex"`
