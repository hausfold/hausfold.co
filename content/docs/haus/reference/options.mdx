...
[`clients`](#haus-ai-clients) [`default`](#haus-ai-default) [`enable`](#haus-ai-enable) [`instructions`](#haus-ai-instructions) [`namer`](#haus-ai-namer) [`repoRoots`](#haus-ai-reporoots) [`skill`](#haus-ai-skill)
