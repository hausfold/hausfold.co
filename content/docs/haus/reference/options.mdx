...
<summary>More detail<span className="sr-only"> on haus.bar.items.factory</span></summary>
...
<summary>More detail<span className="sr-only"> on haus.bar.widgets.&lt;name>.permissions</span></summary>
...
<summary>More detail<span className="sr-only"> on haus.ai.factory.enable</span></summary>
