...
(`increaseContrast`, `differentiateWithoutColor`, `reduceMotion`,
`reduceTransparency`) with a guarded write, which costs you the setting and
nothing else when the grant is missing. [Changing your Mac with an
