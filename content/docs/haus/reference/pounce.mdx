...
Reference for configuring and driving the [launcher](/docs/haus/rooms/launcher).
...
`autoQuit.enabled` turns on [the auto-quit behaviour](/docs/haus/rooms/launcher#quit-an-app-when-its-last-window-closes-opt-in);
