---
title: Coding agents
description: holt gives every coding agent its own checkout, so several can work at once — and closing a pane parks the work rather than losing it. Any git repo, any client.
icon: agent
---
