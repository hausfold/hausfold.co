---
title: The terminal
description: Ghostty, zellij, zsh and a themed toolbelt — the command line haus sets up, and the keys that drive it.
icon: shell
---
...
replacements for the usual commands — every one of them painted in the same
[palette](/docs/haus/guides/theming).
...
in the copy. [Coding agents](/docs/haus/guides/coding-agents) has the rest of the
