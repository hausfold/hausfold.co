...
related:
  - title: "How the flakes fit together"
    ...
    icon: "flake"
  - title: "AI"
    description: "scruff in full: a worktree per agent, parking work instead of losing it, and resuming a parked session."
...
haus, nebelung, pounce, perch and trill are MIT; **scruff** is Apache-2.0. Read
