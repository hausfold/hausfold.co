...
| these docs | [`hausfold.co`](https://github.com/hausfold/hausfold.co), all of them. nebelhaus.com retired into 301s on 2026-08-14, and the workshop's `web/` is that redirect map and nothing else |
