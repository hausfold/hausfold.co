...
- **Buried.** A floating window that has sunk behind your tiled windows.
  ...
  less than a quarter visible, this pill shows its app's logo and name (plus
  `+1` for each other one) and clicking it brings the window back to the front.

**Right, the status cluster**, [toggled below](#toggling-pills).

## What a workspace pill says
