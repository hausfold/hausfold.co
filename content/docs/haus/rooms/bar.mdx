...
| `factory` | The merge lease beside the cup: how much longer this Mac may keep landing pull requests unattended. Click for 4 hours, 12 hours, until revoked, or Revoke; right-click revokes. Nothing at all without `factory` on your PATH, which is [`haus.ai.enable`](/docs/haus/rooms/ai). [Merging overnight](/docs/haus/night-shift) is the setup it belongs to. |
