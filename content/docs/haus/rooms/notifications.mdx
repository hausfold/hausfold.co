---
title: Notifications
description: "Where this desktop's banners come from. haus draws through trill wherever trill answers; this room is the switch that makes haus own the bundle, at a fixed path a Full Disk Access grant can survive, plus the one source haus feeds it from: new mail."
icon: notifications
related:
  - title: "What trill is"
...
### What the mail half does not do
