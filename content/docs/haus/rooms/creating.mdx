...
- **A command on a key.** [`haus.keys.leaderExtras`](/docs/haus/rooms/keys)
  binds the leader plus a key
...
[Keys](/docs/haus/rooms/keys). The reference page regenerates itself; the
prose does not.
</Callout>
