...
dialog and stops; approve it and run the line again. It installs [Determinate
Nix](https://docs.determinate.systems/) for you; by hand, `--from` is nothing
more than `xcode-select --install`, that installer and `git clone`. It finishes
by printing
