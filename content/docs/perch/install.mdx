...
This is the only thing perch ever asks for. It's how a paired iPhone or iPad
finds your Mac, so perch announces itself on whatever network you're on from
the moment it starts, and macOS wants that cleared before it will let it. Say
**Allow** and you never see it again. Say Don't Allow and the shelf still works
exactly as it does below; only the phone half goes quiet, and nothing sent from
a phone will ever arrive. Nothing here reaches past your own network, and there
