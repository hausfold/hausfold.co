---
title: Install
description: Putting perch on your Mac, in order. The one macOS setting to turn off first, a signed download or one brew command, and pairing the free iPhone app. Ten minutes, no terminal needed.
icon: install
related:
  - title: "What perch is"
