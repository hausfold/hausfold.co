...
| **Your iPhone** | The companion app's Share sheet, once you've [paired one](/docs/perch/install). It sends over your network, or peer-to-peer with no network at all, and the phone can pull shelf items back down too |
