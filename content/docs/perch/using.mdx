...
| **Your iPhone** | The companion app's Share sheet, once you pair one: **Pair a Device…** in Settings ▸ Devices on the Mac, then scan the QR with the phone. It sends over your network, or peer-to-peer with no network at all, and the phone can pull shelf items back down too |
