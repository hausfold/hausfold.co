...
| `.well-known/ard.json` | Agentic Resource Discovery catalog listing the MCP server and the OpenAPI spec, for AI clients that probe a domain before reading anything else |
