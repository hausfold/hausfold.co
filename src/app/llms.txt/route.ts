...
- Install haus: https://hausfold.co/haus.sh installs the foundation, the layer with no desktop, so no bar, tiling, palette or wallpaper until a room is turned on. A desktop has a URL of its own: https://hausfold.co/hacker.sh; agent.txt above lists them.
