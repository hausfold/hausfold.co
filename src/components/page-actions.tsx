...
// a product until it exists and is installable by a stranger. The two that
// went are the two nobody here uses; the four that stayed are the two ways
// to read the page as a file and the two models this repo's own docs already
// talk about.
//
// The list is hardcoded rather than passed in: it is a decision about what
// this site endorses, not a per-page setting.
...
export function ViewOptions({
  ...
  const ask = `Read ${pageUrl}, I want to ask questions about it.`;
